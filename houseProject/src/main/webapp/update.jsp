...
<%
    ...
    Bbs bbs = new BbsDAO().getBbs(boardID);
    if(!userID.equals(bbs.getCreaterID())){
       PrintWriter script = response.getWriter();
       script.println("<script>");
        ...
        <div class="row">
            <form method="post" action="updateAction.jsp?bbsID=<%= boardID %>" >
               <table class="table table-striped" style="text-align:center; border:1px solid #dddddd">
                   ...
                   <tbody>
                       <tr>
                           <td><input type="text" class="form-control" placeholder="글 제목" name="boardTitle" maxlength="50" value="<%= bbs.getBoardTitle()%>"/></td>
                       </tr>
                       <tr>
                           <td><textarea class="form-control" placeholder="글 내용" name="boardContent" maxlength="50" style="height:350px;"><%= bbs.getBoardContent()%></textarea></td>
                       </tr>
                   </tbody>
               </table>
